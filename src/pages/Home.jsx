          ...
          <div className="flex flex-col w-1/4 pl-4 gap-4">
            ...
            <div className="flex flex-col h-1/3 bg-white px-4 py-4 rounded-xl gap-4">
              <div className="flex gap-4 items-center ">
                ...
                <p className="font-semibold rounded-full bg-red-600 p-1 text-white w-7 h-7 items-center justify-center">04</p>
              </div>
              <div className="flex gap-2 items-center">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-gray-500 text-xs">A Message has been Recieved</p>
                </div>
              </div>
            </div>
          </div>
